...
export default class Homeclient extends Component {
  ...
  componentDidMount() {
    ...
    if (typeFormSignin === 1) {
      fetch(
        "http://172.16.4.183/wasly_m3ak/api/index.php/Home/home_posts?type=2"
      )
      ...
      fetch(
        "http://172.16.4.183/wasly_m3ak/api/index.php/Home/home_posts?type=1"
      )
        .then(response => response.json())
        .then(responseJson => {
          this.setState({
  ...
  render() {
    return (
      <Container style={{ alignItems: "center" }}>
        ...
        >
          <StatusBar backgroundColor="#1473e7" />
