  ...
  submit() {
    ...
    if (
      ...
      this.refs.toast.show(
        "Please Write Your Phone and Password",
      ...
      var url = "http://172.16.4.183/wasly_m3ak/api/index.php/User/login";
      fetch(url, {
        method: "POST", // or 'PUT'
  ...
  render() {
    return (
      ...
      >
        ...
        <View style={{ alignItems: "center" }}>
          ...
          >
            ...
            >
              <Text
                style={{
                  color: this.state.t_active == 1 ? "#fff" : "#000",
                  alignSelf: "center",
                  fontWeight: "bold",
                  fontSize: this.width * 0.035
                }}
          ...
          >
            <Icon
              name="mobile"
              style={{ marginLeft: this.width * 0.04 }}
            ...
            <TextInput
              ...
              onChangeText={text =>
                this.updateValue((text = this.state.key + text), "phone")
              }
            />
          </Item>
        ...
        >
          <Text style={{ color: "gray", fontSize: this.width * 0.035 }}>
            Don't have an account ?
          </Text>
          <TouchableOpacity
            onPress={() => NavigationService.navigate("SignUp")}
          >
            <Text style={{ color: "#1473e7", fontSize: this.width * 0.035 }}>
              {" "}
              Create new account
            </Text>
          </TouchableOpacity>
