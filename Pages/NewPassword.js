...
export default class NewPassword extends Component {
  ...
  submit() {
    ...
    if (formData.password != this.state.ConfirmPassword) {
      ...
      fetch(
        "http://172.16.4.183/wasly_m3ak/api/index.php/User/updatePassword",
        {
          method: "POST",
          headers: {
        ...
        .then(response => {
          ...
          if (this.state.Resp == 0) {
            this.refs.toast.show(
              "please insert correct phone and password",
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Title style={{ color: "#000", fontSize: 15 }}>New Password</Title>
          </Body>
          {/* <Right style={{ flex: 1 }} /> */}
        </Header>
        <Toast
        ...
        <View style={{ alignItems: "center" }}>
          <Image
            ...
            style={{
              height: "35%",
              width: "35%",
              marginBottom: this.height * 0.02,
              marginTop: this.height * 0.002,
              alignSelf: "center"
            }}
          />
          ...
          >
            ...
            <TextInput
              ...
              onChangeText={Password =>
                this.setState({ Password, backgroundColorPassword: "#f8f8f8" })
              }
              style={{
                textAlign: "center",
