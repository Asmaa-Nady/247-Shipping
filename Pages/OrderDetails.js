  ...
  render() {
    ...
    return (
      <Container style={{ alignItems: "center" }}>
        ...
        >
          <View style={{ flexDirection: "row" }}>
            <Icon
              ...
              onPress={() => NavigationService.navigate("Homeclient")}
            ></Icon>
            <Title
              style={{
                flex: 1,
        ...
        <View style={{ position: "absolute", marginTop: this.heigh * 0.1 }}>
          <Image
        ...
        <View style={{ flexDirection: "row", marginTop: this.heigh * 0.008 }}>
          ...
          <View
            style={{ marginTop: this.heigh * 0.04, flexDirection: "column" }}
          >
            <View
              style={{
        ...
        <View style={{ flexDirection: "row", marginTop: this.heigh * 0.05 }}>
          <View
            style={{ marginLeft: this.width * 0.04, flexDirection: "column" }}
          >
            <View
              style={{
          ...
          <View
            style={{ marginLeft: this.width * 0.01, flexDirection: "column" }}
          >
            <View
              style={{
                backgroundColor: "#d4d4d4",
