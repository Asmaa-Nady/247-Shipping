  ...
  render() {
    return (
      <View>
        ...
        <View>
          <ImageBackground
            source={require("../secoundonborad.jpg")}
            style={{
              height: this.heigh,
              width: this.width
            }}
          >
            <View
              style={{ justifyContent: "center", justifyContent: "flex-start" }}
            >
              <View
                style={{
              ...
              >
                <View style={{ alignItems: "center" }}>
                  <Text style={{ fontSize: this.width * 0.06, color: "#000" }}>
                    Deliver My Goods
                  </Text>
                  <Text
                    style={{
            ...
            >
              <View style={{}}>
                <Button
                  ...
                  light
                  onPress={() =>
                    NavigationService.navigate("FirstOnboard", {
                      userName: "FirstOnboard"
                    })
                  }
                >
