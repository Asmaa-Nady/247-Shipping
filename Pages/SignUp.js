  ...
  signup = () => {
    ...
    if (
      ...
      if (formData.password == "") {
        this.setState({ backgroundColorPassword: "#FFA5A5" });
      }
      if (formData.national_photo == "") {
        this.setState({ backgroundColorPhoto: "#FFA5A5" });
      }
      if (formData.full_name == "") {
        this.setState({ backgroundColorName: "#FFA5A5" });
      }
      if (this.state.ConfirmPassword == "") {
        this.setState({ backgroundColorConfirm: "#FFA5A5" });
      }
    }
    ...
    if (formData.password != this.state.ConfirmPassword) {
      this.refs.toast.show("Password not matched", DURATION.LENGTH_LONG);
      this.setState({
        backgroundColorPassword: "#FFA5A5",
        backgroundColorConfirm: "#FFA5A5"
      });
    } else {
      fetch("http://172.16.4.183/wasly_m3ak/api/index.php/User/signup", {
        method: "POST",
        headers: {
        ...
        .then(res => res.json())
        .then(
          NavigationService.navigate("Activation", {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Title style={{ color: "#000", fontSize: 15 }}>Sign Up</Title>
          </Body>
          <Right style={{ flex: 1 }} />
        </Header>
        <Toast
        ...
        <ScrollView style={{ width: "100%", height: "100%" }}>
          <View style={{ alignItems: "center" }}>
            ...
            >
              <Icon
                name="user"
                style={{ marginLeft: this.width * 0.03 }}
            ...
            >
              ...
              <TextInput
                ...
                onChangeText={PhoneNumber =>
                  this.setState({ PhoneNumber: this.state.key + PhoneNumber })
                }
            ...
            <Item
              ...
              style={{
                ...
                justifyContent: "space-around",
                width: "80%",
                backgroundColor: this.state.backgroundColorPassword,
                marginTop: 5
              }}
            >
              <Icon
              ...
              <TextInput
                ...
                secureTextEntry={this.state.secureTextEntryone}
                onChangeText={Password => this.setState({ Password })}
                style={{
                  textAlign: "center",
                  marginLeft: this.width * 0.08,
                  marginRight: this.width * 0.13
                }}
              />
              <Icon
                name={this.state.iconNameone}
                size={this.width * 0.05}
            ...
            <Item
              ...
              style={{
                ...
                justifyContent: "space-around",
                width: "80%",
                backgroundColor: this.state.backgroundColorConfirm,
                marginTop: 5
              }}
            >
              <Icon
              ...
              <TextInput
                ...
                secureTextEntry={this.state.secureTextEntrytwo}
                style={{
                  textAlign: "center",
                  marginLeft: this.width * 0.08,
                  marginRight: this.width * 0.13
          ...
          >
            <ListItem>
              <Radio
                selected={this.state.itemSelected == "traveler"}
                onPress={() =>
                  this.setState({
              ...
              />
              <Text style={{ marginLeft: 5, fontSize: 12 }}>Traveler</Text>
            </ListItem>
            <ListItem>
              <Radio
                selected={this.state.itemSelected == "client"}
                onPress={() =>
                  this.setState({
                    itemSelected: "client",
                    Type: "2"
              ...
              />
              <Text style={{ marginLeft: 5, fontSize: 12 }}>Client</Text>
            </ListItem>
            <ListItem>
              <Radio
                selected={this.state.itemSelected == "point"}
                onPress={() =>
                  this.setState({
                    itemSelected: "point",
                    Type: "1"
              ...
              />
              <Text style={{ marginLeft: 5, fontSize: 12 }}>Point</Text>
            </ListItem>
          </View>
