...
export default class ProfilePage extends Component {
  ...
  componentDidMount() {
    fetch(
      "http://172.16.4.183/wasly_m3ak/api/index.php/User/user_to_settings?member_id=18"
    )
  ...
  submit() {
    ...
    if (
      ...
      if (formData.email == "") {
        this.setState({ backgroundColorEmail: "#FFA5A5" });
      }
    }
          ...
          <ScrollView key={key} style={{ width: "100%", height: "100%" }}>
            ...
            >
              ...
              >
                ...
                <TextInput
                  onChangeText={full_name =>
                    this.setState({ full_name, backgroundColorName: "#f8f8f8" })
                  }
                  ...
                  style={{
                    ...
                    marginRight: this.width * 0.08,
                    marginTop: this.width * 0.02
                  }}
                >
                  {item.full_name}
                </TextInput>
              ...
              >
                ...
                <TextInput
                  onChangeText={email =>
                    this.setState({ email, backgroundColorEmail: "#f8f8f8" })
                  }
              ...
              >
                <Icon
                  name="mobile"
                  size={this.width * 0.08}
                  style={{ marginLeft: this.width * 0.08 }}
                />
                <TextInput
                  onChangeText={phone =>
                    this.setState({ phone, backgroundColorPhone: "#f8f8f8" })
                  }
            ...
            <Dialog.Container visible={this.state.visible}>
              <Text
                style={{ textAlign: "center", fontSize: this.width * 0.06 }}
              >
                Change Password
              </Text>
              <Item
