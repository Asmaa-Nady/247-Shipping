...
import { TextInput, Dimensions, AsyncStorage } from "react-native";
...
export default class Post extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      "http://172.16.4.183/wasly_m3ak/api/index.php/Posts/points?language=en"
    )
    ...
    fetch(
      "http://172.16.4.183/wasly_m3ak/api/index.php/Posts/categories?language=en"
    )
      .then(response => response.json())
      .then(responseJson => {
        this.setState({
  ...
  submit() {
    ...
    if (
      ...
      if (formData.from_city == "") {
        this.setState({ backgroundColorFromCity: "#FFA5A5" });
      }
      if (formData.to_city == "") {
        this.setState({ backgroundColorToCity: "#FFA5A5" });
      }
      if (formData.travel_date == "") {
        this.setState({ backgroundColorDate: "#FFA5A5" });
      }
      if (formData.travel_time == "") {
        this.setState({ backgroundColorTime: "#FFA5A5" });
      }
      if (formData.weight == "") {
        this.setState({ backgroundColorWeight: "#FFA5A5" });
      }
      if (formData.title == "") {
        this.setState({ backgroundColorTitle: "#FFA5A5" });
      }
      if (formData.category_id == "") {
        this.setState({ backgroundColorCategoryId: "#FFA5A5" });
      }
      if (formData.description == "") {
        this.setState({ backgroundColorDescription: "#FFA5A5" });
      }
    } else {
      var url = "http://172.16.4.183/wasly_m3ak/api/index.php/Posts/createPost";
      fetch(url, {
        method: "POST", // or 'PUT'
        ...
        .then(response => {
          ...
          if (this.state.Resp === 0) {
            this.refs.toast.show("Please Full All Data", DURATION.LENGTH_LONG);
  ...
  render() {
    return (
      <Container>
        ...
        <Content
          style={{
            marginLeft: this.height * 0.02,
            marginRight: this.height * 0.02
          }}
        >
          <Form
            style={{
          ...
          >
            <Item
              ...
              style={{
                ...
                backgroundColor: this.state.backgroundColorFromCity
              }}
            >
              <Text
                style={{
            ...
            <Item
              ...
              style={{
                width: "45%",
                height: this.height * 0.06,
                backgroundColor: this.state.backgroundColorToCity
              }}
            >
              <Text
                style={{
          ...
          <TextInput
            ...
            style={{
              ...
              marginLeft: this.height * 0.02,
              marginRight: this.height * 0.02,
              backgroundColor: this.state.backgroundColorTitle,
              borderTopLeftRadius: 0,
              borderTopRightRadius: 30,
              borderBottomRightRadius: 30,
              borderBottomLeftRadius: 30
          ...
          >
            <View style={{ flexDirection: "column" }}>
              <Text style={{ color: "#424242", fontSize: this.width * 0.04 }}>
                Date
              </Text>
              <DatePicker
                style={{
                  width: 90,
                  backgroundColor: this.state.backgroundColorDate
                }}
                ...
                onDateChange={date => {
                  this.setState({ date: date, backgroundColorDate: "#f8f8f8" });
                }}
              />
            </View>
            <View style={{ flexDirection: "column" }}>
              ...
              <DatePicker
                style={{
                  width: 80,
                  backgroundColor: this.state.backgroundColorTime
                }}
                ...
                onDateChange={time => {
                  this.setState({ time: time, backgroundColorTime: "#f8f8f8" });
                }}
              />
            </View>
            <View style={{ flexDirection: "column" }}>
              ...
              <TextInput
                ...
                style={{
                  ...
                  textAlign: "center",
                  backgroundColor: this.state.backgroundColorWeight,
                  borderColor: "#424242",
                  fontSize: this.width * 0.03,
                  borderTopLeftRadius: 0,
                  borderTopRightRadius: 30,
          ...
          <View style={{}}>
            <Item
              rounded
              style={{
                backgroundColor: this.state.backgroundColorDescription,
                marginRight: this.height * 0.02,
                marginLeft: this.height * 0.02,
                marginTop: this.height * 0.001
              }}
          ...
          <Button
            ...
            onPress={() => this.submit()}
          >
            <Text style={{ fontSize: this.width * 0.03, color: "white" }}>
              Post
            </Text>
          </Button>
        </Content>
